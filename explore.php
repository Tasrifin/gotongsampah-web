...
<head>
  ...
  <script type="text/javascript">
    function hapusData(dt)
    {
      $.ajax({
        type : 'POST',
        data : {
          submit : "submit_delete_donasi",
          id_donasi : dt
        },
    ...
    function konfirmasiDonasi(dt)
    {
      $.ajax({
        type : 'POST',
        data : {
          submit : "submit_konfirm_donasi",
          id_donasi : dt,
          uname_mitra : $("#uname_mitra_konfirmasi"+dt).val(),
          hp_mitra : $("#hp_mitra_konfirmasi"+dt).val()          
        },
        url : 'php/controller.php',
        success: function(data)
        {
    ...
    function updateDonasi(dt)
    {
      $.ajax({
        type : 'POST',
        data : {
          submit : "submit_update_donasi",
          id_donasi : dt,
          judul_donasi : $("#judul_donasi"+dt).val(),
          jenis_sampah : $("#jenis_sampah"+dt).val(), 
          berat_sampah : $("#berat_sampah"+dt).val(),
          deskripsi : $("#deskripsi"+dt).val(),
          alamat : $("#alamat"+dt).val(),
          tlp : $("#tlp"+dt).val()        
        },
    ...
    <section class="section">
      <div class="container">
        <div class="row">
          ...
          <?php 
          $query2 = "SELECT * FROM donasi ORDER BY id_donasi DESC";
        ...
        {
        echo "Tidak Ada Data Donasi Sampah";
        }
